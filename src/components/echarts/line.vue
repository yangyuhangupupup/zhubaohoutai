 ...
 * @LastEditors: yyh
 * @LastEditTime: 2021-09-11 22:03:11
-->
<template>
  <div class="line">
    <div class="first">销售总额 (元)</div>
    <div class="second">
      <div class="item">
        <div class="title">今日</div>
        <div class="info">
          <span class="num">8.65</span>
          <span class="font">万</span>
        </div>
      </div>
      <div class="item">
        <div class="title">昨日</div>
        <div class="info">
          <span class="num green">8.65</span>
          <span class="font">万</span>
        </div>
      </div>
      <div class="item">
